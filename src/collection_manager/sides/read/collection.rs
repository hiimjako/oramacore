...
use oramacore_lib::collection_values::CollectionValuesReader;
...
pub struct CollectionReader {
    ...
    values_reader: OramaAsyncLock<CollectionValuesReader>,
...
impl CollectionReader {
    pub async fn empty(
        ...
        Ok(Self {
            ...
            values_reader: OramaAsyncLock::new("values_reader", CollectionValuesReader::empty()),
    ...
    pub async fn try_load(
        ...
        let s = Self {
            ...
            values_reader: OramaAsyncLock::new(
                "values_reader",
                CollectionValuesReader::try_load(data_dir.clone())
                    .context("Cannot load collection values reader")?,
            ),
    ...
    pub async fn update(
        ...
        **updated_at_lock = Utc::now();
        ...
        match collection_operation {
            ...
            CollectionWriteOperation::CollectionValue(op) => {
